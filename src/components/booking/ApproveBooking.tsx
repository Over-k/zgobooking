...
export default function ApproveBooking({booking}: {booking: BookingWithRelations}) {
    ...
    const [isOpen, setIsOpen] = useState(false);
        ...
        const handleApproveBooking = async (bookingId: string) => {
          ...
          try {
            ...
            // Optionally, you can refresh the bookings list or show a success message
          } catch (error) {
